...
namespace Assignment4_Account
{
    ...
    {
        // Why access private in Program.cs with private
        ...
        public static Person GetPerson(string name)
        {
            ...
            throw new AccountException(AccountException.ExceptionEnum.USER_DOES_NOT_EXIST);
        }
        ...
        public static Account GetAccount(string number)
        {
            ...
            throw new AccountException(AccountException.ExceptionEnum.ACCOUNT_DOES_NOT_EXIST);
        }
